...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    @Query("select new com.nhnacademy.minidooray.taskapi.domain.TaskResponseByProjectId(t.taskId, t.title, t.registrantAccount, t.milestone.milestoneName) from Task t left join t.milestone m where t.project.projectId=:projectId")
    List<TaskResponseByProjectId> findByProjectId(@Param("projectId") Long projectId);
}
